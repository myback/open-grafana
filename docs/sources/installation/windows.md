...
To run Grafana, open your browser and go to the Grafana port (http://localhost:8080/ is default) and then follow the instructions in [Getting Started]({{< relref "../getting-started/getting-started/" >}}).
